...
class VideoActionDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        self.lerobot_dataset = WrappedLeRobotSingleDataset(
            ...
            shared_video_views=shared_video_views,
...
class MultiVideoActionDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        if args is not None:
            ...
            video_modality_keys = getattr(args, "video_modality_keys", video_modality_keys)
            ...
            shared_video_views = getattr(args, "shared_video_views", shared_video_views)
